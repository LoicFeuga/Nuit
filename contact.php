		...
		<div align="center">
			<form action="/">
				...
				<div class="info">
					...
					<input type="text" name="name" id="connexion-id" placeholder="Nom" required/></br>
					<label id="icon" for="name"><i class="icon-user"></i></label>
				...
				<div class="texteare">
					<hr>
						<textarea name="textear" cols="80" rows="15" id="textear" placeholder="Votre message" required/></textarea>
					</hr>
				</div>
				</hr>
